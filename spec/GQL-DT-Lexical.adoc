...
|`∨` |`OR`, `{vbar}{vbar}` |Disjunction |2 |Left
|`→` |`=++>++` |Implication |1 |Right
|`⇒` |`==++>++` |Implication |1 |Right
...
|2 |`∨`, `OR`, `{vbar}{vbar}` |Left |Logical disjunction
...
* `GQL++_++Dependent++_++Types++_++Complete++_++Specification.md` - Type system specification
